...
%>
	...
	<div class="container">
		...
		<div class="top">
			<div class="box">
				<form action="AdminLeavePage.jsp">
					<br> <input type="submit" value="Leave ">
				</form>
			</div>
			<div class="box">
				<form action="AdminComplaintpage.jsp">
		...
		<div class="bottom">
			...
			<div class="box">
				<form action="AdminStudentData.jsp">
					<br> <input type="submit" value="Student Data ">
				</form>
			</div>
			<div class="box">
				<form action="AdminRoomDetails.jsp">
